...
io.on('connection', function(socket){ //3
  ...
  socket.on('chat question', function(question){ //3-3
    ...
    else if(question.includes("한국IT") || question.includes("한국it") || question.includes("한국 IT") || question.includes("한국 it")){
    ...
    else if(question.includes("인공지능") ||  question.includes("AI") ||  question.includes("ai")){
    ...
    else if(question.includes("챗봇") ||  question.includes("chatbot") ||  question.includes("CHATBOT")){
    ...
    else if(question.includes("코로나") || question.includes("covid") || question.includes("COVID")){
